// Creates the restaurants table (if it doesn't exist yet) and seeds it
// with starter data. Run with: npm run db:setup
//
// Needs DATABASE_URL in the environment — run via
// `node --env-file=.env.local scripts/setup-db.mjs` (see package.json).
